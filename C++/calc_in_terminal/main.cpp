...
int main(int argc,char* argv[])
{
	...
	int pat = 0; // variable for numbers at left side operator
	int pat_do = 0; // variable for numbers at right side operator
	...
	{
		std::cout << "You must be write operators!!!" << std::endl;
	}
	delete[] arr;
	delete[] mas1;
	delete[] mas2;	
